...
public class Main {
    ...
    public static void Medic() {
        Random random = new Random();
        int randHealth = random.nextInt(100) + 1;
        int a = random.nextInt(3);
        if (heroesHealth[a] < 100 && heroesHealth[a] > 0) {
            heroesHealth[a] = heroesHealth[a] + randHealth;
            System.out.println("Medic healed " + heroesAttackType[a] + "on " + randHealth + " point");
        } else {
            System.out.println("Medic skip");
        }
    }
